...
<body>
    <div class="admin-container">
        ...
        <div class="admin-main">
            ...
            <p>Selamat datang kembali di dashboard Alvr. Di sini Anda dapat mengelola artikel dan kategori Anda.</p>
            <div class="article-section">
                <div class="article-card">
                    <h3>Write your article</h3>
                    <p>Mulailah menulis artikel baru Anda dan bagikan pengetahuan serta pengalaman Anda dengan komunitas ALVR BLOG. Klik tombol di bawah ini untuk memulai.</p>
